...
5VPOKEP,2:L=JAND3:S=STICK(0):IFJ>=K*100THENK=K+1:F=0
6IFSTHENVPOKEP,M:P=P+32*(S=1)-32*(S=5)-(S=3)+(S=7):J=J+1:Q=Q-.001
7VPOKEG,36:G=6148:IFSTHENIFL=3THENG=O+1+FNR(640):VPOKEG,4
8IFSTRIG(0)ANDF<9THENVPOKEP-1,32:VPOKEP+1,32:VPOKEP-32,32:VPOKEP+32,32:F=F+1
9ON-(P<DANDP>OANDVPEEK(P)<>M)GOTO3:?"END":FORI=OTOD:NEXT:F=0:GOTO0