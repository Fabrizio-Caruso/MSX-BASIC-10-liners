...
1DEFUSR=159:A=USR(0):Y=19:W=111:KEYOFF:DEFFNR(X)=INT(RND(1)*X):J=0:VPOKE8192,49
...
4LOCATE5,0:?CHR$(W)J"  HI"R"  TI"H" "Y:S=STICK(0):IFRND(1)>.95THENVPOKEX,191
5Y=Y+(Y>3):IFSTHENVPOKEP,N:Q=P+(S=7)-(S=3)+N*(S=1)-N*(S=5):IFVPEEK(Q)<>MTHENP=Q
6X=O+33+FNR(608):IFVPEEK(P)=191THENY=19ELSEIFRND(1)>.95THENVPOKEX,M
